...
const AisleBlock2 = () => {
  ...
  useFrame(() => {
    // Additional frame-by-frame logic can be placed here if needed
  });
  ...
  return <primitive object={group} position={[0, 0, 0]} rotation={[0, Math.PI / 2, 0]} />;
};

export default AisleBlock2;
